...
public:
	 ...
	 */
	void kill(MM_EnvironmentBase *env,  OMRPool *pool, omrthread_monitor_t mutex)
	{
		tearDown(env);
	 ...
	 */
	static MM_ConcurrentSweepPoolState *newInstance(MM_EnvironmentBase *env, OMRPool *pool, omrthread_monitor_t mutex, MM_MemoryPool *memoryPool)
	{
